...
module.exports = dialect => {
  const availableJoinTypes = ['natural', 'cross', 'inner', 'outer', 'left', 'right', 'full', 'self'];
  ...
  dialect.templates.add('joinItem', {
    ...
    validate: (type, params) => {
      ...
      templateChecks.customProp('join', params, 'type', value => {
        const splitType = _(value.toLowerCase().split(' ')).compact();
