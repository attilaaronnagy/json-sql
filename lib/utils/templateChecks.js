...
exports.requiredProp = (type, params, propName) => {
  if (_.isUndefined(params[propName])) {
    throw new Error('`' + propName + '` property is not set in `' + type + '` clause');
  }
};

exports.atLeastOneOfProps = (type, params, expectedPropNames) => {
  const propNames = _(params)
    .chain()
    .keys()
...
exports.onlyOneOfProps = (type, params, expectedPropNames) => {
  const propNames = _(params)
    .chain()
    .keys()
    .intersection(expectedPropNames)
...
exports.propType = (type, params, propName, expectedTypes) => {
  ...
  const hasSomeType = _(expectedTypes).some(expectedType => {
...
exports.minPropLength = (type, params, propName, length) => {
  if (_.isUndefined(params[propName])) return;
...
exports.propMatch = (type, params, propName, regExp) => {
  if (_.isUndefined(params[propName])) return;
...
exports.customProp = (type, params, propName, fn) => {
  if (_.isUndefined(params[propName])) return;
