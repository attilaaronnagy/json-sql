...
describe('Union, except, intersect', function() {
  ...
  describe('type & all combinations', function() {
    ...
    it('should be ok with `type` = "union" subquery', function() {
      ...
      expect(result.query).to.be.equal('select * from (select * from "users" union select * ' + 'from "vipusers");');
      expect(result.values).to.be.eql({});
    });
  });
  ...
  describe('sort', function() {
    it('should be ok with string value', function() {
      ...
      expect(result.query).to.be.equal('select * from "users" union select * from "vipusers" order by "age";');
      expect(result.values).to.be.eql({});
    });
    ...
    it('should be ok with array value', function() {
      ...
      expect(result.query).to.be.equal('select * from "users" union select * from "vipusers" order by "age", "gender";');
      expect(result.values).to.be.eql({});
    });
    ...
    it('should be ok with object value', function() {
      ...
      expect(result.query).to.be.equal('select * from "users" union select * from "vipusers" order by "age" asc, "gender" desc;');
      expect(result.values).to.be.eql({});
    });
  });
  ...
  describe('limit, offset', function() {
    it('should be ok with `limit` property', function() {
      ...
      expect(result.query).to.be.equal('select * from "users" union select * from "vipusers" limit 5;');
      expect(result.values).to.be.eql({});
    });
    ...
    it('should be ok with `offset` property', function() {
      ...
      expect(result.query).to.be.equal('select * from "users" union select * from "vipusers" offset 5;');
      expect(result.values).to.be.eql({});
    });
    ...
    it('should be ok with `limit` and `offset` properties', function() {
      ...
      expect(result.query).to.be.equal('select * from "users" union select * from "vipusers" limit 10 offset 20;');
      expect(result.values).to.be.eql({});
    });
  });
});
